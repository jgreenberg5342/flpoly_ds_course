...
author: "Jake Greenberg- `jgreenberg5342@floridapoly.edu`"
...
a. Make sure your GitHub repo (`flpoly_ds_course/`) shows the results of your updated file (remember to use the commands `git add .` , `git commit -m "YOUR MESSAGE"`, and `git push`) **DONE**

b. Include a link to your GitHub repo in this document. [**My GitHub Repository**](https://github.com/jgreenberg5342/flpoly_ds_course)

c. Take a screenshot of the GitHub repo, add the screenshot file to the repo, and include it in this document (review how to insert a picture using markdown) **DONE**
...
- I've learned the basics for creating and understanding time series data
- I've learned how to create time series models in STATA

## Statistical Learning

- I've learned [how to use Markdown in RStudio](https://www.markdownguide.org/basic-syntax/)
